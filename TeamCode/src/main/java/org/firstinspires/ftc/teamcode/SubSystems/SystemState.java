...
public class SystemState {
    ...
    public static final double SHOULDER_ARM_PICKUP_FACTOR = ((Shoulder.THRESHOLD_POSITION - Shoulder.PICKUP_POSITION)/
            ((Arm.MAX_EXTENDED_POSITION - Arm.PICKUP_POSITION)));

    public static final double SHOULDER_ARM_LOW_JUNCTION_FACTOR = ((Shoulder.THRESHOLD_POSITION - Shoulder.PICKUP_POSITION)/
            ((Arm.MAX_EXTENDED_POSITION - Arm.PICKUP_POSITION)));
