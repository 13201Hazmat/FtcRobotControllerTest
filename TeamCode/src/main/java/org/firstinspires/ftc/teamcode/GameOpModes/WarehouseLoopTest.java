...
public class WarehouseLoopTest extends LinearOpMode {
    ...
    public void buildAutoWarehouse(){
        if (GameField.playingAlliance == GameField.PLAYING_ALLIANCE.BLUE_ALLIANCE) {
            ...
            warehouseAllianceShippingPathPose[0] = new Pose2d(-71, 3, Math.toRadians(90));
            warehouseAllianceShippingPathPose[1] = new Pose2d(-72, 3, Math.toRadians(90));
            warehouseAllianceShippingPathPose[2] = new Pose2d(-73, 3, Math.toRadians(90));

            allianceShippingHubDropElementPose = new Pose2d(-31, 1 , Math.toRadians(135)); //x = -32, y= -3
