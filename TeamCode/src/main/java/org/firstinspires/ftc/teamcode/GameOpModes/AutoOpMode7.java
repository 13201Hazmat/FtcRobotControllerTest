 ...
 */
@Autonomous(name = "Hazmat Auto 7", group = "00-Autonomous", preselectTeleOp = "Hazmat TeleOp")
public class AutoOpMode7 extends LinearOpMode{
    ...
    public void buildAuto() {
        switch (startPosition) {
            case BLUE_LEFT:
                ...
                pickAndDropHighPose = new Pose2d(-13, 39, Math.toRadians(90));
