...
public class SampleTankDrive extends TankDrive {
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx leftFront = hardwareMap.get(DcMotorEx.class, "flmotor");
        DcMotorEx leftRear = hardwareMap.get(DcMotorEx.class, "blmotor");
        DcMotorEx rightRear = hardwareMap.get(DcMotorEx.class, "brmotor");
        DcMotorEx rightFront = hardwareMap.get(DcMotorEx.class, "frmotor");
