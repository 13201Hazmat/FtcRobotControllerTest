 ...
 */
@Autonomous(name = "Hazmat Auto 1+2 Lakeshore Back Medium", group = "00-Autonomous", preselectTeleOp = "Hazmat TeleOp")
public class AutonomousLakeShoreOnePlus2BackMedium extends LinearOpMode{
    ...
    public void buildAuto() {
        switch (startPosition) {
            case BLUE_LEFT:
                ...
                pickConeAadiPose[1] = new AadiPose(2073,330, Hand.WRIST_STATE.WRIST_LEVEL, -665); // arm 1st : 2089, shoulder 1st : 295, arm 2nd: 832, shoulder 2nd: 175
                pickConeAadiPose[2] = new AadiPose(2261,315, Hand.WRIST_STATE.WRIST_LEVEL, -665); //shoulder first angle 275,  shoulder second: 266, arm second: 957
                pickConeAadiPose[3] = new AadiPose(2180,300, Hand.WRIST_STATE.WRIST_LEVEL, -665); //shoulder first angle 225, arm second: 983, shoulder second: 177
                pickConeAadiPose[4] = new AadiPose(2327,229, Hand.WRIST_STATE.WRIST_LEVEL, -665); // shoulder 210, shoulder second: 132, arm second: 1108
                pickConeAadiPose[5] = new AadiPose(2404,165, Hand.WRIST_STATE.WRIST_LEVEL, -665);
            ...
            case BLUE_RIGHT:
                ...
                dropConeBackHigh = new AadiPose(1460,760, Hand.WRIST_STATE.WRIST_UP, 1850);
                pickConeAadiPose[1] = new AadiPose(2140,347, Hand.WRIST_STATE.WRIST_LEVEL, 665);
                pickConeAadiPose[2] = new AadiPose(2206,322, Hand.WRIST_STATE.WRIST_LEVEL, 665);
                pickConeAadiPose[3] = new AadiPose(2259,252, Hand.WRIST_STATE.WRIST_LEVEL, 665);
                pickConeAadiPose[4] = new AadiPose(2219,206, Hand.WRIST_STATE.WRIST_LEVEL, 665);
                pickConeAadiPose[5] = new AadiPose(2379,160, Hand.WRIST_STATE.WRIST_LEVEL, 665);
                //endAadiPose = new AadiPose(0,shoulder.MAX_RAISED_POSITION, Hand.WRIST_STATE.WRIST_LEVEL, 0);
                break;
            ...
            case RED_LEFT:
                ...
                pickConeAadiPose[1] = new AadiPose(2073,336, Hand.WRIST_STATE.WRIST_LEVEL, -665); // arm 1st : 2089, shoulder 1st : 295, arm 2nd: 832, shoulder 2nd: 175
                pickConeAadiPose[2] = new AadiPose(2261,321, Hand.WRIST_STATE.WRIST_LEVEL, -665); //shoulder first angle 275,  shoulder second: 266, arm second: 957
                pickConeAadiPose[3] = new AadiPose(2180,306, Hand.WRIST_STATE.WRIST_LEVEL, -665); //shoulder first angle 225, arm second: 983, shoulder second: 177
                pickConeAadiPose[4] = new AadiPose(2327,235, Hand.WRIST_STATE.WRIST_LEVEL, -665); // shoulder 210, shoulder second: 132, arm second: 1108
                pickConeAadiPose[5] = new AadiPose(2404,171, Hand.WRIST_STATE.WRIST_LEVEL, -665); // shoulder 115, shoulder second:44  , arm second: 1117
                break;
