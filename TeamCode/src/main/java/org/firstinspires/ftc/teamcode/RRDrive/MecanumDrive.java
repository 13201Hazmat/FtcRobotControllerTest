...
public class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.0005367477415473052; //1
        public double lateralInPerTick = 0.0003156705817550493; //inPerTick
        public double trackWidthTicks =  25989.030374812366;//23527, 25989.030374812366;

        // feedforward parameters (in tick units)
        public double kS = 2.217018252042081;//0
        public double kV = 0.00007372693352992634;//0
        public double kA = 0.000027;//0

        // path profile parameters (in inches)
        public double maxWheelVel = 60;//50;//before: 50, new 60
        public double minProfileAccel = -40;//-30;//-50; //-30
        public double maxProfileAccel = 60;//50;//73; //50
        ...
        public double axialGain = 9.0;//0.0; 9.0 //new 12
        ...
        */
        ...
        //NEW TUNING
        // drive model parameters
        public double inPerTick = 0.00053836221724814;//1; //223827
        public double lateralInPerTick =  0.00032024825882889097; //0.0002907694083017339; //inPerTick;
        public double trackWidthTicks =  25483.02991354662; //1;

        // feedforward parameters (in tick units)
        public double kS = 1.8060166782731075;//0;
        public double kV = 0.00008029109327091949;//0;
        public double kA = 0.000027;//0;

        // path profile parameters (in inches)
        public double maxWheelVel = 60;//60//50;//before: 50, new 60
        public double minProfileAccel = -40;//-40//-30;//-50; //-30
        public double maxProfileAccel = 60;//60//50;//73; //50
        ...
        public double headingGain = 8.0;

        public double axialVelGain = 0; //generateSMARTDerivativeTerm.(axialGain, false);//0.0
        public double lateralVelGain = 0; //0.027490041684727597; //generateSMARTDerivativeTerm(lateralGain, false); //0.0
        public double headingVelGain = 0; //generateSMARTDerivativeTerm(headingGain, false); // shared with turn
