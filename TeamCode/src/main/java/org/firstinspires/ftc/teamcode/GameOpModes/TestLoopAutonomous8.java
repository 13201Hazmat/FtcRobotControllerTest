...
@Autonomous(name = "Test loop Autonomous 8", group = "00-Autonomous" , preselectTeleOp = "TeleOp")
@Disabled
public class TestLoopAutonomous8 extends LinearOpMode {
    ...
    public void buildAutoWarehouse(){
        if (GameField.playingAlliance == GameField.PLAYING_ALLIANCE.BLUE_ALLIANCE) {
            ...
            warehousePickElementPose = new Pose2d(-72, 47, Math.toRadians(90));
