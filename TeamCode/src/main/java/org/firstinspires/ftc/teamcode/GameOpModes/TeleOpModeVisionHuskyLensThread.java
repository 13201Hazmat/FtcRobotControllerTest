 ...
 *
 */
@TeleOp(name = "Hazmat TeleOp Husky Thread", group = "00-Teleop")
public class TeleOpModeVisionHuskyLensThread extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStopRequested()) {
            ...
            while (opModeIsActive()) {
                ...
                if (visionSensor.backdropDistanceState == VisionSensor.BACKDROP_DISTANCE_STATE.AMBER) {
