...
### New features
* Adds new `VisionPortal` API for computer visionTfod
...
* Includes Vuforia Ultimate Goal visionTfod targets and sample OpModes.
...
## Version 2.20 (released on 16.09.08)
  ...
  * Modified computer visionTfod code to require an individual Vuforia license (per legal requirement from PTC).
  * Minor fixes.
 ...
 * Vuforia Computer Vision SDK integrated into FTC SDK.  Users can use sample visionTfod targets to get localization information on a standard FTC field.
